   ...
   return (
      <div>
         <div className="container p-2 mx-auto sm:p-4 ">
            <h2 className="mb-4 text-2xl pl-9  font-semibold leading-tight">
               MarkSheet - Student Name - Course Name
            </h2>
            <h3 className="mb-4 text-xl pl-9 pb-5 font-semibold leading-tight text-zinc-600">
               Semester 1
            </h3>
                  ...
                  <tbody>
                     {subjects?.mark_list?.map((item) => (
                        ...
                        >
                           ...
                           <td className="p-3">
                              <p className="font-bold text-green-700 capitalize">{item?.status}</p>
                           </td>
                        </tr>
                     ))}
                  </tbody>
